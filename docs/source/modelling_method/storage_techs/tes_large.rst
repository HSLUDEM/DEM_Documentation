...
The TES technology represents a large scale thermal energy Storage
connected to the district heating network. It can be charged by all 
the technologies that are defined via the connections parameters in
the input file. The thermal energy storage is modelled as a simple
...
assumed to be useful heat that can be directly used in the district
heating network. 

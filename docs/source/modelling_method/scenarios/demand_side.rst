...
For electric vehicle (EV) charging demand modelling, see :ref:`electricity_demand_ev`. Flexibility from EV charging is implemented as defined by Herrera and Hug (2025) and includes lower and upper charging power limits, as well as the daily available flexible energy.

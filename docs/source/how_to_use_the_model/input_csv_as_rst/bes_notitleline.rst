...
+---------------------------------+------------------------------------------+----------------+--------------+-----------+--------+
| ``bes_gamma``                   | Loss rate: fraction of electricity lost  | 0.001          | 1/timestep   | float     |        |
|                                 |                                          |                |              |           |        |
...
+---------------------------------+------------------------------------------+----------------+--------------+-----------+--------+
| ``initial_charge``              | Initial charge of battery (fraction of   | 0              | —            | float     |        |
|                                 |                                          |                |              |           |        |
...
+---------------------------------+------------------------------------------+----------------+--------------+-----------+--------+
| ``lifetime``                    | Expected lifetime of technology before   | 10             | years        | int       |        |
|                                 |                                          |                |              |           |        |
...
|                                 | costs (if required).                     |                |              |           |        |
+---------------------------------+------------------------------------------+----------------+--------------+-----------+--------+
| ``capex``                       | CAPEX cost of technology per unit of     | 500            | CHF/kWh      |           |        |
|                                 |                                          |                |              |           |        |
|                                 | capacity.                                |                |              |           |        |
+---------------------------------+------------------------------------------+----------------+--------------+-----------+--------+
| ``maintenance_cost``            | OPEX of the technology                   | 2              | CHF/kWh/year | float     |        |
+---------------------------------+------------------------------------------+----------------+--------------+-----------+--------+

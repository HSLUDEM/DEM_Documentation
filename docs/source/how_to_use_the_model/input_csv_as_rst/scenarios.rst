...
+========================+======+===========+==========================================+
| demand_side            | —    | bool      | If set to 'true', the demand side        |
|                        |      |           | scenario will be implemented. This       |
|                        |      |           | scenario consists of future climate and  |
|                        |      |           | demand scenarios specified in the        |
|                        |      |           | 'demand_side' dict.                      |
+------------------------+------+-----------+------------------------------------------+
| fossil_heater_retrofit | —    | bool      | If set to 'true', the fossil heating     |
...
|                        |      |           | wood_boiler).                            |
+------------------------+------+-----------+------------------------------------------+
| pv_integration         | —    | bool      | If set to 'true', the PV integration     |
...
+------------------------+------+-----------+------------------------------------------+
| wind_integration       | —    | bool      | If set to 'true', the wind power         |
...
+------------------------+------+-----------+------------------------------------------+
| thermal_energy_storage | —    | bool      | If set to 'true', the thermal energy     |
...
|                        |      |           | 'tes' technology.                        |
+------------------------+------+-----------+------------------------------------------+
| nuclear_phaseout       | —    | bool      | If set to 'true', a nuclear phaseout     |

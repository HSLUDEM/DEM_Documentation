...
+----------------------------------------+------------------------------------------+--------------------------+------+------------+
| ``nuclear_power_plant_powers``         | Net electric power of the nuclear power  | [1010, 1233, 365, 365]   | —    | List[MW]   |
|                                        |                                          |                          |      |            |
...
+----------------------------------------+------------------------------------------+--------------------------+------+------------+
| ``nuclear_power_plant_shutdown_years`` | Expected shutdown years of the nuclear   | [2039, 2045, 2033, 2032] | —    | List[year] |
|                                        |                                          |                          |      |            |

...
+-----------------------------+------------------------------------------+----------------+--------------+-----------+--------+
| hes_gamma                   | Loss rate: fraction of electricity lost  | 0              | 1/timestep   | float     |        |
|                             |                                          |                |              |           |        |
...
+-----------------------------+------------------------------------------+----------------+--------------+-----------+--------+
| initial_charge              | Initial charge of battery (fraction of   | 1              | —            | float     |        |
|                             |                                          |                |              |           |        |
...
|                             | costs (if required).                     |                |              |           |        |
+-----------------------------+------------------------------------------+----------------+--------------+-----------+--------+
| capex                       | CAPEX cost of technology per unit of     | 15             | CHF/kWh      | float     |        |
|                             |                                          |                |              |           |        |
|                             | capacity.                                |                |              |           |        |
+-----------------------------+------------------------------------------+----------------+--------------+-----------+--------+
| maintenance_cost            | OPEX of the technology                   | 1              | CHF/kWh/year | float     |        |
+-----------------------------+------------------------------------------+----------------+--------------+-----------+--------+

...
|                     |              |           | optimisation.                            |
+---------------------+--------------+-----------+------------------------------------------+
| deploy_existing     | —            | bool      | If set to 'true', existing gas turbine   |
|                     |              |           |                                          |
|                     |              |           | will be deployable.                      |
+---------------------+--------------+-----------+------------------------------------------+
| kW_el_max           | kW           | float     | Maximum capacity (electric power output) |
|                     |              |           |                                          |
|                     |              |           | of newly built CHP gas turbines.         |
+---------------------+--------------+-----------+------------------------------------------+
| force_cap_max       | kW           | bool      | Force implementation of maximum capacity |
|                     |              |           |                                          |
...
+---------------------+--------------+-----------+------------------------------------------+
| heat_export_subsidy | CHF/kWh      | float     | Export subsidy for heat. Can be needed   |
|                     |              |           |                                          |

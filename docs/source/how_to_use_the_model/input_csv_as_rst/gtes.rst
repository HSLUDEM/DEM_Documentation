...
|                             |              |           | optimisation.                            |
+-----------------------------+--------------+-----------+------------------------------------------+
| force_asynchronous_prod_con | —            | bool      | If set to 'true', the storage cannot be  |
...
+-----------------------------+--------------+-----------+------------------------------------------+
| gtes_gamma                  | 1/timestep   | float     | Loss rate: fraction of gas lost during   |
...
+-----------------------------+--------------+-----------+------------------------------------------+
| initial_charge              | —            | float     | Initial charge of gas tank (fraction of  |
...
|                             |              |           | costs (if required).                     |
+-----------------------------+--------------+-----------+------------------------------------------+
| capex                       | CHF/kWh      | float     | CAPEX cost of technology per unit of     |
|                             |              |           | capacity.                                |
+-----------------------------+--------------+-----------+------------------------------------------+

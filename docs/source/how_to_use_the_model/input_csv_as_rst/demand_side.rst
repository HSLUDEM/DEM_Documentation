...
+------------------------------------------+------------------------------------------+------------------------------------------+------+------------------+--------+
| ``total_renovation_heat_generator_reassi | In manual scenarios (no optimization),   | {                                        | —    | Dict[str, float] |        |
|                                          |                                          |                                          |      |                  |        |
| gnment_rates_space_heating_for_manual_sc | what heat generators are installed after |             'v_h_eh' : 0.0, 'v_h_hp' :   |      |                  |        |
|                                          |                                          |                                          |      |                  |        |
| enarios``                                | total renovation for space heating.      | 0.8, 'v_h_dh' : 0.05, 'v_h_gb' : 0.05,   |      |                  |        |
|                                          |                                          |                                          |      |                  |        |
|                                          |                                          | 'v_h_ob' : 0.05,                         |      |                  |        |
|                                          |                                          |                                          |      |                  |        |
...
| ``total_renovation_heat_generator_reassi | In manual scenarios (no optimization),   | {                                        | —    | Dict[str, float] |        |
|                                          |                                          |                                          |      |                  |        |
| gnment_rates_dhw_for_manual_scenarios``  | what heat generators are installed after |             'v_hw_eh' : 0.05, 'v_hw_hp'  |      |                  |        |
|                                          |                                          |                                          |      |                  |        |

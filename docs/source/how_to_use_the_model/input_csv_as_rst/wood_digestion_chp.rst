...
+------------------------+--------------+-----------+------------------------------------------+
| efficiency_electricity | -            | float     | Conversion efficiency                    |
+------------------------+--------------+-----------+------------------------------------------+
| efficiency_heat        |              | float     | Conversion efficiency                    |
+------------------------+--------------+-----------+------------------------------------------+
...
|                        |              |           | capacity.                                |
+------------------------+--------------+-----------+------------------------------------------+
| maintenance_cost       | CHF/kWp/year | float     | OPEX cost of the technology per unit of  |
|                        |              |           |                                          |
|                        |              |           | capacity.                                |
+------------------------+--------------+-----------+------------------------------------------+

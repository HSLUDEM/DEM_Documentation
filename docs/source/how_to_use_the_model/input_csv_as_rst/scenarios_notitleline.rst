...
+----------------------------+-----------------------------------------------+----------------+------+-----------+
| ``demand_side``            | If set to 'true', the demand side             | False          | —    | bool      |
|                            |                                               |                |      |           |
...
|                            | ``demand_side`` dict.                         |                |      |           |
+----------------------------+-----------------------------------------------+----------------+------+-----------+
| ``fossil_heater_retrofit`` | If set to 'true', the fossil heating          | False          | —    | bool      |
|                            |                                               |                |      |           |
...
|                            | ``wood_boiler``).                             |                |      |           |
+----------------------------+-----------------------------------------------+----------------+------+-----------+
| ``pv_integration``         | If set to 'true', the PV integration          | False          | —    | bool      |
|                            |                                               |                |      |           |
...
+----------------------------+-----------------------------------------------+----------------+------+-----------+
| ``wind_integration``       | If set to 'true', the wind power              | False          | —    | bool      |
|                            |                                               |                |      |           |
...
+----------------------------+-----------------------------------------------+----------------+------+-----------+
| ``thermal_energy_storage`` | If set to 'true', the thermal energy          | False          | —    | bool      |
|                            |                                               |                |      |           |
...
+----------------------------+-----------------------------------------------+----------------+------+-----------+
| ``nuclear_phaseout``       | If set to 'true', a nuclear phaseout          | False          | —    | bool      |
|                            |                                               |                |      |           |

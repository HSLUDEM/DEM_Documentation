...
+--------+-----------------------------------------------+-----------+-----------------------------------------------------------+---------------------------------------------+
| 26     | ``TotalEnergy``                               | float     | Total annual generated energy in kWh                      | Calculated based on ``TotalPower`` using an |
|        |                                               |           |                                                           |                                             |
|        |                                               |           | from solar PV installation.                               | assumed value of full load hours (e.g.,     |
|        |                                               |           |                                                           |                                             |
|        |                                               |           |                                                           | 1000 kWh/kWp).                              |
+--------+-----------------------------------------------+-----------+-----------------------------------------------------------+---------------------------------------------+
...
+--------+-----------------------------------------------+-----------+-----------------------------------------------------------+---------------------------------------------+
| 29     | ``renovation_base``                           | float     | Only required for ``demand_side`` scenario                | Calculated using renovation rates           |
|        |                                               |           |                                                           |                                             |
|        |                                               |           | with renovation. Year of renovation for                   | scenario based on Streicher at al.          |
|        |                                               |           |                                                           |                                             |
|        |                                               |           | this building (in the future) for                         | (2021). See :ref:`renovation-scenario`      |
|        |                                               |           |                                                           |                                             |
|        |                                               |           | renovation scenario "base" (e.g., 2045).                  |                                             |
+--------+-----------------------------------------------+-----------+-----------------------------------------------------------+---------------------------------------------+
| 30     | ``renovation_low``                            | float     | Only required for ``demand_side`` scenario                | Calculated using renovation rates           |
|        |                                               |           |                                                           |                                             |
|        |                                               |           | with renovation. Year of renovation for                   | scenario based on Streicher at al.          |
|        |                                               |           |                                                           |                                             |
|        |                                               |           | this building (in the future) for                         | (2021). See :ref:`renovation-scenario`      |
...
+--------+-----------------------------------------------+-----------+-----------------------------------------------------------+---------------------------------------------+
| 31     | ``renovation_high``                           | float     | Only required for ``demand_side`` scenario                | Calculated using renovation rates           |
|        |                                               |           |                                                           |                                             |
|        |                                               |           | with renovation. Year of renovation for                   | scenario based on Streicher at al.          |
|        |                                               |           |                                                           |                                             |
|        |                                               |           | this building (in the future) for                         | (2021). See :ref:`renovation-scenario`      |
...
+--------+-----------------------------------------------+-----------+-----------------------------------------------------------+---------------------------------------------+
| 32     | ``heat_energy_demand_estimate_kWh_combined``  | float     | Annual space heating demand in kWh.                       | Computed according to Schneeberger et       |
|        |                                               |           |                                                           |                                             |
|        |                                               |           |                                                           | al. (2025). See also                        |
|        |                                               |           |                                                           |                                             |
...
|        |                                               |           | individual building.                                      |                                             |
+--------+-----------------------------------------------+-----------+-----------------------------------------------------------+---------------------------------------------+
| 45     | ``LocalHydroPotential_Pumpspeicherkraftwerk`` | float     | Share of local annual pumped storage                      | See :ref:`hydro_power`                      |
|        |                                               |           |                                                           |                                             |
